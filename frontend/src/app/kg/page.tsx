    ...
    <div className="flex h-[calc(100vh-8rem)] flex-col space-y-3">
      <div>
        ...
        <p className="text-muted-foreground">
          Skills sit in the center: evidence on the left, offers to the right,
          organizations one hop further. Click a node for details, double-click
          to focus its neighborhood.
        </p>
      </div>
